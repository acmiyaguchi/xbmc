...
void InputState::ResetState(unsigned int buttonCount /* = GAMEPAD_BUTTON_COUNT */,
...
void InputState::SetAxis(unsigned int axis, long value, long maxAxisAmount)
{
  if (axis >= axes.size())
    return;
...
void InputState::ProcessButtonPresses(const InputState& newState)
{
...
void InputState::ProcessHatPresses(const InputState& newState)
{
...
void InputState::ProcessAxisMotion(const InputState& newState)
{
